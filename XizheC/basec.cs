            ...
            try
            {
                ...
                for (int i = 0; i < GridView1.Rows.Count; i++)
                {
                    for (int x = 0; x < GridView1.Columns.Count; x++)
                    {
                        ...
                        {
                            if (GridView1.Rows[i].Cells[x].Text == "&nbsp;")
                            {

                            }
                            else if (GridView1.Rows[i].Cells[x].GetType() == typeof(string))
                            {
                                excel.Cells[i + 2, x + 1] = "'" + GridView1.Rows[i].Cells[x].Text;
                            }
                            else
                            {
                                excel.Cells[i + 2, x + 1] = GridView1.Rows[i].Cells[x].Text;
