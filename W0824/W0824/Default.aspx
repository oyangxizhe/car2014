<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="W0824._Default" %>
...
<meta name ="keywords" content ="车辆管理系统,车辆管理软件,ERP,小微企业管理系统,希哲软件" />
    ...
    <input id="hint" type="hidden"  runat="server" />
        ...
        <div style="height:360px;margin-top:40px; margin-bottom:0px;">
            <div style="width:45%; float:left; border-right:solid 1px #ccc; height:100%; text-align:right; padding-right:30px;">
                <br />
                <br />
                <img id="Img1" src="Image/logo.jpg" runat=server /><br />
