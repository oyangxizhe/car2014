...
namespace W0824.BaseInfo
{
    public partial class CarInfo : System.Web.UI.Page
    {
        ...
        basec bc = new basec();
        protected string M_str_sql = @"SELECT A.CAID,A.PLATENUM,A.CAR_NATURE,A.CARTYPE,A.CARBRAND,
A.USEUNITPRICE AS USEUNITPRICE,A.DRIVERID AS DRIVERID,(SELECT ENAME FROM EMPLOYEEINFO WHERE EMID=A.DRIVERID) AS DRIVER,(SELECT ENAME FROM EMPLOYEEINFO 
WHERE EMID=A.MAKERID ) AS MAKER,
A.MAKERID,A.DATE,A.YEAR,A.MONTH FROM CarINFO A ";
        protected string M_str_table = "CarInfo";
        ...
        protected void select()
        {
            ...
            if (Text1.Value != "" && StartDate.Value == "" && EndDate.Value == "")
            {
                ...
                M_str_sql1 = M_str_sql +" where A.PLATENUM like '%" + Text1.Value + "%'";
            ...
            {
                M_str_sql1 = M_str_sql + " where A.DATE BETWEEN  '" + v5 + "'AND '" + v6 + "' AND A.PLATENUM LIKE '%" + Text1.Value + "%'";
                dt = basec.getdts(M_str_sql1);
                if (dt.Rows.Count > 0)
                {
                    GridView1.DataSource = dt;
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "CAID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.BaseInfo.CarInfoT.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../BaseInfo/CarInfoT.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (bc.JuageIfAllowDeleteCAR_CAID(id))
                {
                    hint.Value = bc.ErrowInfo;
                }
                else
                {
                    string strSql = "DELETE FROM CarInfo WHERE CAID='" + id + "'";
