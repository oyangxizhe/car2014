<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerInfo.aspx.cs" Inherits="W0824.BaseInfo.CustomerInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
                ...
                <div >
                 ...
                 <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("CUID") %>','<%#Eval ("CName") %>','<%#Eval ("ADDRESS") %>','<%#Eval ("CONTACT") %>','<%#Eval ("PHONE") %>','<%#Eval ("BASEUNITPRICE") %>','<%#Eval ("CUKEY") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="客户名称">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("CNAME") %>'></asp:LinkButton>                     
                </ItemTemplate>
