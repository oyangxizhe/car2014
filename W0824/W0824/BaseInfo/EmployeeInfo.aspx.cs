...
namespace W0824.BaseInfo
{
    public partial class EmployeeInfo : System.Web.UI.Page
    {
        ...
        basec bc = new basec();
        protected string M_str_sql = @"SELECT A.EMID AS EMID,A.ENAME AS ENAME,A.DEPART AS DEPART,A.POSITION AS POSITION,(SELECT ENAME FROM EMPLOYEEINFO 
...
A.MAKERID,A.DATE,A.YEAR,A.MONTH FROM EMPLOYEEINFO A ";
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.BaseInfo.EmployeeInfoT.strE[0] = str[0];
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                if (bc.JuageIfAllowDeleteCAR_EMID(id))
                {
                    hint.Value = bc.ErrowInfo;
                }
                else
