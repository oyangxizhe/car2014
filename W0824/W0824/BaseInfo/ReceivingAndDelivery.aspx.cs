...
namespace W0824.BaseInfo
{
    public partial class ReceivingAndDelivery : System.Web.UI.Page
    {
        ...
        basec bc = new basec();
        protected string M_str_sql = @"select  A.RDID AS RDID,A.CONAME AS CONAME,A.PHONE AS PHONE,
...
RECEIVINGANDDELIVERY A";
        ...
        protected void select()
        {
            ...
            if (Text1.Value != "" && StartDate.Value == "" && EndDate.Value == "")
            {
                ...
                M_str_sql1 = M_str_sql + " where A.CONAME like '%" + Text1.Value + "%'";
            ...
            {
                M_str_sql1 = M_str_sql + " where A.DATE BETWEEN  '" + v5 + "'AND '" + v6 + "' AND A.CONAME LIKE '%" + Text1.Value + "%'";
                dt = basec.getdts(M_str_sql1);
                if (dt.Rows.Count > 0)
                {
                    GridView1.DataSource = dt;
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.BaseInfo.ReceivingAndDeliveryT.strE[0] = str[0];
