<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerInfoT.aspx.cs" Inherits="W0824.BaseInfo.CustomerInfoT" %>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103"/> 
   ...
   <input id="Text2" type="text"  runat ="server"  class ="c13111105" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text2" Text="必填！" runat="server" /></div>
    ...
    <div class="c13101903" id ="Div7">
     ...
     <div class="c13102401" id ="Div8">
        <input id="Text3" type="text"  runat="server"    readonly ="readonly"  class="c14111906" /></div>
   ...
   <input id="Text5" type="text"  runat ="server"  readonly ="readonly" class="c13112201"/> 
     ...
     <div class="c13102401" id ="Div17">
   <input id="Text6" type="text"  runat ="server" readonly ="readonly" class="c14111906" /></div>
             <div class="c13101903" id ="Div15">
                 吨数</div>
     <div class="c13101904" id ="Div21">
   <input id="Text9" type="text"  runat ="server"   readonly ="readonly" class="c13112201" /> 
         </div>
           </div>
   ...
   <input id="Text10" type="text"  runat ="server"   readonly ="readonly" class="c13112201" /> 
         </div>
         </div>
     ...
     <span style =" margin-right :20px;  display :none "><asp:Button ID="btnClear" runat="server" Text="清空" 
         ...
         <asp:Button ID="btnAddDeliveryAddress" runat="server" Text="添加" 
             ...
             <span class ="c13112202">需先添加地址信息,然后单击联系人为默认联系信息,最后点保存即可</span></div>
...
<div class ="c13111602">
           ...
           <asp:TemplateField HeaderText="联系人" >
              ...
              <asp:TemplateField HeaderText="吨数">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox8" runat="server"  Text='<%#Eval ("吨数") %>' Width ="100px"  ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="100px" />
                 <ItemStyle Width="100px"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
              <asp:TemplateField HeaderText="基础单价">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox9" runat="server"  Text='<%#Eval ("基础单价") %>' Width ="100px"  ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="100px" />
                 <ItemStyle Width="100px"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
            ...
            <asp:BoundField DataField="PHONE" HeaderText="联系电话" >
                            ...
                            <asp:BoundField DataField="ADDRESS" HeaderText="地址" >
                              ...
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                ...
                                <asp:BoundField DataField="BOXS" HeaderText="吨数" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
                                <asp:BoundField DataField="BASEUNITPRICE" HeaderText="基础单价" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
                    </Columns>
