...
{
    public partial class Toll : System.Web.UI.Page
    {
        DataTable dt = new DataTable();
        basec bc = new basec();
        protected string M_str_sql = @"
SELECT A.TOID AS TOID,A.CAID AS CAID,B.PLATENUM AS PLATENUM,C.DRIVERID AS DRIVERID,
D.ENAME AS DRIVER,A.Toll_DATE AS Toll_DATE,A.TOLL_PLACE AS TOLL_PLACE,A.PAYMENT AS PAYMENT,G.CNAME AS CNAME,
...
LEFT JOIN CUSTOMERINFO_MST G ON F.CUID=G.CUID";
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.CostManage.TollT.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../CostManage/TollT.aspx" + n2);
