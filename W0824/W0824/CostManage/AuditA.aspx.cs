...
{
    public partial class AuditA : System.Web.UI.Page
    {
...
LEFT JOIN CUSTOMERINFO_MST F ON E.CUID=F.CUID";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "AUID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.CostManage.AuditTA.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../CostManage/AuditTA.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                sql = "DELETE Audit WHERE AUID='" + id + "'";
                basec.getcoms(sql);
