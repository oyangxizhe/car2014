<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpkeepTA.aspx.cs" Inherits="W0824.CostManage.UpkeepTA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑保养费用信息(核)</title>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103" /> 
   ...
   <input id="Text2" type="text"  runat ="server" onclick ="f13100202('Text2','')" class ="c13110901" />  </div>
...
<input id="Text4" type="text"  runat="server"    class="c13102103" /> 
     ...
     <input id="Text5" type="text"  runat="server"   class="c13110901"/> </div>
