...
{
    public partial class GasTA : System.Web.UI.Page
    {
...
LEFT JOIN CARINFO B ON A.CAID=B.CAID WHERE A.TOLLCARDID='" + Text7.Value + "'");
            ...
            else if (DropDownList1.Text == "现金支付" & Text8.Value == "")
            {
                ju = false;
                hint.Value = "选择现金支付时单价不能为空！！";
            }
        ...
        protected void btnExit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("../CostManage/GasA.aspx" + n2);
        }
