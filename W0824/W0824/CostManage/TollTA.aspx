<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TollTA.aspx.cs" Inherits="W0824.CostManage.TollTA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑过路费用信息(核)</title>
...
<div class="c13122502" id ="Div24">
   <input id="Text5" type="text"  runat ="server" class ="c13110901" onclick ="f13100202('Text5','')" readonly ="readonly"  /> 
     ...
     <input id="Text6" type="text"  runat="server"   class="c14011902"/> </div>
     ...
     <div class="c14120501" id ="Div19">
                   <asp:DropDownList ID="DropDownList1" runat="server"  CssClass ="c13102104">
                     <asp:ListItem>路卡支付</asp:ListItem>
...
<input id="Text7" type="text"  runat="server"  onclick ="f13100202('Text7','')" class="c13102103" /> 
...
<input id="Text9" type="text"  runat="server"    class="c14011901" /> 
          <span style =" margin-left :5px;">
             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="Text9" Text="必填！" runat="server" />
                    </span>
         </div>
...
<div class="c14120501" id ="Div31">
     <input id="Text10" type="text"  runat="server" onclick ="f13100202('Text10','')"      class="c13110901" />
     ...
     <div class="c13122401" id ="Div109">
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
           ...
           dlgResult = window.showModalDialog("../tollcardmanage/tollcardsearch.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0;");
                  if (dlgResult != undefined) {
