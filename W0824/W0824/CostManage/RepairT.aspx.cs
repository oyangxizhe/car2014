...
{
    public partial class RepairT : System.Web.UI.Page
    {
...
SELECT A.REID AS REID,A.CAID AS CAID,B.PLATENUM AS PLATENUM,C.DRIVERID AS DRIVERID,
D.ENAME AS DRIVER,
...
UCID='" + Text12.Value + "',REPAIR_DATE='" + Text2.Value + "',CAID='" + v3 + "',HANDLERID='" + Text6.Value +
        ...
        protected void btnExit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("../CostManage/Repair.aspx" + n2);
        }
