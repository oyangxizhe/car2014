...
{
    public partial class InsureTA : System.Web.UI.Page
    {
        ...
        protected string M_str_sql = @"SELECT A.INID AS INID,A.CAID AS CAID,B.PLATENUM AS PLATENUM,C.DRIVERID AS DRIVERID,
...
";
        ...
        protected void btnExit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("../CostManage/InsureA.aspx" + n2);
        }
