<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WashTA.aspx.cs" Inherits="W0824.CostManage.WashTA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑轮胎费用信息(核)</title>
...
<input id="Text12" type="text"  runat="server"  onclick ="f13100202('Text12','')" class="c14011901" /> 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="Text1" Text="必填！" runat="server" />
         </div>
