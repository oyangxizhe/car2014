<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gas.aspx.cs" Inherits="W0824.CostManage.Gas" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <asp:TemplateField HeaderText="加油单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("GAID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                ...
                <asp:BoundField DataField="UCID" HeaderText="用车单号" >
                        ...
                        <asp:BoundField DataField="GasCARD_MRCOUNT" HeaderText="油库耗油(L)" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
                            <asp:BoundField DataField="AMOUNT" HeaderText="加油金额" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                          </asp:BoundField>
