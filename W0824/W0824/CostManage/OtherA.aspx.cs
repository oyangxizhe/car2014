...
{
    public partial class OtherA : System.Web.UI.Page
    {
...
B.CARTYPE AS CARTYPE,C.Other_COST AS Other_COST,A.COST_NAME AS COST_NAME,
...
LEFT JOIN CUSTOMERINFO_MST F ON E.CUID=F.CUID";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "OTID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.CostManage.OtherTA.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../CostManage/OtherTA.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                sql = "DELETE Other WHERE OTID='" + id + "'";
                basec.getcoms(sql);
