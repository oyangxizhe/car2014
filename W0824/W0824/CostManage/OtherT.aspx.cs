...
{
    public partial class OtherT : System.Web.UI.Page
    {
...
SELECT A.OTID AS OTID,A.CAID AS CAID,B.PLATENUM AS PLATENUM,C.DRIVERID AS DRIVERID,
...
";
        ...
        protected void btnExit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("../CostManage/Other.aspx" + n2);
        }
