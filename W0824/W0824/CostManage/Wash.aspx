<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wash.aspx.cs" Inherits="W0824.CostManage.Wash" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <asp:TemplateField HeaderText="轮胎维修单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("WAID") %>'></asp:LinkButton>                     
                </ItemTemplate>
               ...
               <asp:BoundField DataField="UCID" HeaderText="用车单号" >
                            ...
                            <asp:BoundField DataField="PLATENUM" HeaderText="车牌号码" >
                             ...
                             <asp:BoundField DataField="WASH_COST" HeaderText="金额" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
