...
{
    public partial class GasA : System.Web.UI.Page
    {
        DataTable dt = new DataTable();
        basec bc = new basec();
        protected string M_str_sql = @"
SELECT A.GAID AS GAID,A.CAID AS CAID,B.PLATENUM AS PLATENUM,C.DRIVERID AS DRIVERID,
D.ENAME AS DRIVER,A.Gas_DATE AS Gas_DATE,A.Gas_STATION AS Gas_STATION,A.PAYMENT AS PAYMENT,F.CNAME AS CNAME,
...
END
AS GasCARD_MRCOUNT,
CASE WHEN A.PAYMENT='现金支付' THEN C.Gas_COST
ELSE 0
END
AS AMOUNT,
C.GasCARD_MRCOUNT AS GasCARD_MRCOUNT,
...
LEFT JOIN CUSTOMERINFO_MST F ON E.CUID=F.CUID";
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.CostManage.GasTA.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../CostManage/GasTA.aspx" + n2);
