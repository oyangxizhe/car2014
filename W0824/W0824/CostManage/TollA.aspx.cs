...
{
    public partial class TollA : System.Web.UI.Page
    {
...
END
AS TOLLCARD_MRCOUNT,
CASE WHEN A.PAYMENT='现金支付' THEN  C.Toll
ELSE 0
END
AS AMOUNT,
E.TOLLCARDID AS TOLLCARDID,
C.TOLLCARD_MRCOUNT AS TOLLCARD_MRCOUNT,
A.HANDLERID AS HANDLERID,(SELECT ENAME FROM EMPLOYEEINFO WHERE EMID=A.HANDLERID) AS HANDLER,G.CNAME AS CNAME,
A.REMARK AS REMARK,
...
ELSE '未审核'
END 
AS AUDIT_STATUS,C.UCID AS UCID,
...
LEFT JOIN UCAPPLY_DET F ON A.UCID=F.UCID
LEFT JOIN CUSTOMERINFO_MST G ON F.CUID=G.CUID";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "TOID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.CostManage.TollTA.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../CostManage/TollTA.aspx" + n2);
