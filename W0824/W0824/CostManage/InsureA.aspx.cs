...
{
    public partial class InsureA : System.Web.UI.Page
    {
        DataTable dt = new DataTable();
        basec bc = new basec();
        protected string M_str_sql = @"SELECT A.INID AS INID,A.UCID AS UCID,A.CAID AS CAID,B.PLATENUM AS PLATENUM,C.DRIVERID AS DRIVERID,
D.ENAME AS DRIVER,B.CARTYPE AS CARTYPE,C.INSURE_COST AS INSURE_COST,A.INSUDF AS INSUDF,
A.HANDLERID AS HANDLERID,(SELECT ENAME FROM EMPLOYEEINFO WHERE EMID=A.HANDLERID) AS HANDLER,F.CNAME AS CNAME,
A.REMARK AS REMARK,
...
LEFT JOIN UCAPPLY_DET E ON A.UCID=E.UCID
LEFT JOIN CUSTOMERINFO_MST F ON E.CUID=F.CUID";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "INID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.CostManage.InsureTA.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../CostManage/InsureTA.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                sql = "DELETE INSURE WHERE INID='" + id + "'";
                basec.getcoms(sql);
