...
{
    public partial class WashA : System.Web.UI.Page
    {
...
C.Wash_COUNT*C.Wash_UNITPRICE AS Wash_COST,A.REMARK AS REMARK,
...
LEFT JOIN EMPLOYEEINFO D ON D.EMID=C.DRIVERID";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "WAID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.CostManage.WashTA.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../CostManage/WashTA.aspx" + n2);
