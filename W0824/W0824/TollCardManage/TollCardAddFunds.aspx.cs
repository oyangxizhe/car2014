...
{
    public partial class TollCardAddFunds : System.Web.UI.Page
    {
...
LEFT JOIN GODE D ON A.TFKEY=D.GEKEY";
        ...
        protected void select()
        {
            ...
            if (Text1.Value != "" && StartDate.Value == "" && EndDate.Value == "")
            {
                ...
                M_str_sql1 = M_str_sql +" where C.TollCARDID like '%" + Text1.Value + "%'";
            ...
            {
                M_str_sql1 = M_str_sql + " where A.DATE BETWEEN  '" + v5 + "'AND '" + v6 + "' AND C.TollCARDID LIKE '%" + Text1.Value + "%'";
                dt = basec.getdts(M_str_sql1);
                if (dt.Rows.Count > 0)
                {
                    GridView1.DataSource = dt;
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "TFID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.TollCardManage.TollCardAddFundsT.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../TollCardManage/TollCardAddFundsT.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sql = "DELETE TOLLCARDADDFUNDS WHERE TFID='" + id + "'";
            string v1 = bc.getOnlyString("SELECT TOLLCARD_GECOUNT FROM GODE WHERE GODEID='" + id + "'");
            string v2 = bc.getOnlyString("SELECT TCID FROM TOLLCARDADDFUNDS WHERE TFID='"+id+"'");
         
            try
            {
                if (bc.JuageDeleteCount_MoreThanStorageCount_toll(v2, v1))
                {
                    hint.Value = bc.ErrowInfo;
                }
                else
        ...
        {
            string var1 = bc.numYM(10, 4, "0001", "SELECT * FROM TollCardAddFunds", "TFID", "TF");
            TollCardAddFundsT.str1[0] = var1;
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../TollCardManage/TollCardAddFundsT.aspx"+n2);
        }
