...
{
    public partial class GasCardAddFunds : System.Web.UI.Page
    {
        DataTable dt = new DataTable();
        basec bc = new basec();
        protected string M_str_sql = @"
SELECT A.GFID AS GFID,A.GCID AS GAID,C.GASCARDID AS GASCARDID,B.PLATENUM AS PLATENUM,
...
LEFT JOIN GASCARDINFO C ON A.GCID=C.GCID
...
";
        ...
        protected void select()
        {
            ...
            if (Text1.Value != "" && StartDate.Value == "" && EndDate.Value == "")
            {
                ...
                M_str_sql1 = M_str_sql +" where C.GASCARDID like '%" + Text1.Value + "%'";
            ...
            {
                M_str_sql1 = M_str_sql + " where A.DATE BETWEEN  '" + v5 + "'AND '" + v6 + "' AND C.GASCARDID LIKE '%" + Text1.Value + "%'";
                dt = basec.getdts(M_str_sql1);
                if (dt.Rows.Count > 0)
                {
                    GridView1.DataSource = dt;
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "GFID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.GasCardManage.GasCardAddFundsT.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../GasCardManage/GasCardAddFundsT.aspx" + n2);
        ...
        {
            string var1 = bc.numYM(10, 4, "0001", "SELECT * FROM GasCardAddFunds", "GFID", "GF");
            GasCardAddFundsT.str1[0] = var1;
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../GasCardManage/GasCardAddFundsT.aspx"+n2);
        }
