<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasCardInfoT.aspx.cs" Inherits="W0824.GasCardManage.GasCardInfoT" %>
...
<input id="Text4" type="text"  runat="server"    class="c13102103" />
   ...
   <input id="Text5" type="text"  runat="server" onclick ="f13100202('Text5')" readonly="readonly" class="c13102103" />
     ...
     <input id="Text6" type="text"  runat="server"    class="c14011101" />
      ...
      <div class="c13101903" id ="Div27">
          购买油站 </div>
     <div class="c13102402" id ="Div28">
           <input id="Text7" type="text"  runat="server"  class="c14011102"/></div>
