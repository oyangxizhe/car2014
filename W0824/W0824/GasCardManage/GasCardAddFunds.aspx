<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasCardAddFunds.aspx.cs" Inherits="W0824.GasCardManage.GasCardAddFunds" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server"
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("GFID") %>','<%#Eval ("GASCARDID") %>');">选取</a>
                   </ItemTemplate>
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
                            ...
                            <asp:BoundField DataField="PLATENUM" HeaderText="车牌号码" >
                             ...
                             <asp:BoundField DataField="GECOUNT" HeaderText="冲值金额" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
