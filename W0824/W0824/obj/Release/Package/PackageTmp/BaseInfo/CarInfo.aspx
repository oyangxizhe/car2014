<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarInfo.aspx.cs" Inherits="W0824.BaseInfo.CarInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("CAID") %>','<%#Eval ("PLATENUM") %>','<%#Eval ("CAR_NATURE") %>',
         '<%#Eval ("CARTYPE") %>','<%#Eval ("USEUNITPRICE") %>','<%#Eval ("DRIVERID") %>','<%#Eval ("DRIVER") %>');">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="车牌号码">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("PLATENUM") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="60px" />
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                             <asp:BoundField DataField="Car_NATURE" HeaderText="车辆属性" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                          ...
                          <asp:BoundField DataField="CarType" HeaderText="车辆类型" >
                            ...
                            <asp:BoundField DataField="CarBRAND" HeaderText="汽车品牌" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                          </asp:BoundField>
