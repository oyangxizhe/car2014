<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRight.aspx.cs" Inherits="W0824.UserManage.EditRight" %>
             ...
             <asp:TemplateField HeaderText="用户名">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("UNAME") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="60px" />
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                   
                            <asp:BoundField DataField="ENAME" HeaderText="用户姓名" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
                                  <asp:BoundField DataField="NodeContext" HeaderText="权限名称" >
