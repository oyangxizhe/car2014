<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TollCardAddFundsT.aspx.cs" Inherits="W0824.TollCardManage.TollCardAddFundsT" %>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103" /> 
   ...
   <input id="Text3" type="text"  runat="server"    class="c14011101"  />
...
<input id="Text4" type="text"  runat="server"    class="c14011301" />
   <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="Text4" Text="必填" runat="server" />                 
     ...
     <span style =" margin-right :8px;">
   <input id="Text5" type="text"  runat="server" onclick ="f13100202('Text5')" readonly="readonly" class="c13102103" />
       
                    </span> </div>
                             <div class="c13101903" id ="Div18">
                                 经手人</div>
     <div class="c14112608" id ="Div19">
     ...
     <div class="c13122401" id ="Div109">
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
              var dlgResult;
              if (obj == "Text2") {
                  dlgResult = window.showModalDialog("../tollcardmanage/tollcardinfo.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0;");
