<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherTA.aspx.cs" Inherits="W0824.CostManage.OtherTA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑其它费用信息(核)</title>
...
<div class="c13122502" id ="Div24">
   <input id="Text7" type="text"  runat ="server" class ="c13110901"  onclick ="f13100202('Text7','')" readonly ="readonly"  /> 
     ...
     <input id="Text5" type="text"  runat="server"   class="c14011902"/> </div>
