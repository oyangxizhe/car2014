<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditTA.aspx.cs" Inherits="W0824.CostManage.AuditTA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑加水费用信息(核)</title>
...
<input id="Text12" type="text"  runat="server"  onclick ="f13100202('Text12','')" class="c14011901" /> 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="Text1" Text="必填！" runat="server" /></div>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103" /> 
   ...
   <input id="Text2" type="text"  runat ="server"  onclick ="f13100202('Text2','')"   class="c14011901" /> 
 </div>
...
<input id="Text4" type="text"  runat="server"    class="c13102103" /> 
 ...
 <asp:DropDownList ID="DropDownList1" runat="server"  CssClass ="c13102104">
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="DropDownList1" Text="必填！" runat="server" />
                    </span>
                    </div>                         
                                 <div class="c13101903" id ="Div16">
                              收费单位 </div>
     <div class="c13122502" id ="Div17">
     <input id="Text5" type="text"  runat="server"   class ="c14011505" /> </div>
           <div class="c13101903" id ="Div20">
          金额 </div>
     <div class="c14120501" id ="Div22">
<input id="Text6" type="text"  runat="server"    class="c14011901" /> 
          <span style =" margin-left :5px;">
