<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasT.aspx.cs" Inherits="W0824.CostManage.GasT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑加油费用信息</title>
...
<input id="Text8" type="text"  runat="server" class="c14011901" /> 
          <span style =" margin-left :5px;">
...
<div class="c13122502" id ="Div31">
     ...
     <div class="c13122401" id ="Div109">
      ...
      <div class="c13101903" id ="Div32">
          数量(L)</div>
     <div class="c14011302" id ="Div33">
        <input id="Text11" type="text"  runat="server"    class="c13102908"/></div>
           </div>
