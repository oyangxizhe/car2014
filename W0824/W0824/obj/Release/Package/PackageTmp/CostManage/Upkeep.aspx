<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upkeep.aspx.cs" Inherits="W0824.CostManage.Upkeep" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <asp:TemplateField HeaderText="保养单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("UPID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 ...
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
                            ...
                            <asp:BoundField DataField="Upkeep_cost" HeaderText="保养金额" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                          </asp:BoundField>
