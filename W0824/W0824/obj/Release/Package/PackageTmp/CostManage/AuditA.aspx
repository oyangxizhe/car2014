<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditA.aspx.cs" Inherits="W0824.CostManage.AuditA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>加水费用维护(核)</title>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <asp:TemplateField HeaderText="加水单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("AUID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                ...
                <asp:BoundField DataField="UCID" HeaderText="用车单号" >
                       ...
                       <asp:BoundField DataField="CNAME" HeaderText="客户名称" >
                            ...
                            <asp:BoundField DataField="AUDIT_COST" HeaderText="加水金额" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                          </asp:BoundField>
