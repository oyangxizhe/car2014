<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insure.aspx.cs" Inherits="W0824.CostManage.Insure" %>
...
<span id="i13052904"  class ="c13110505"  >
     ...
     <input id="StartDate" type="text" runat="server" onclick ="f13100202('StartDate')" class ="c13102103" />
          ...
          <div class="c13110102" id ="Div12">
                 <span style=" margin-right :53px;"></span></div>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                    ...
                    onrowdatabound="GridView1_RowDataBound" 
                        ...
                        AutoGenerateColumns="False" style="margin-left: 8px ;width: 98%;" PageSize="15" 
                         CssClass ="c13102001"
             ...
             <asp:TemplateField HeaderText="罚款单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("INID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="60px" />
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                <asp:BoundField DataField="UCID" HeaderText="用车单号" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                         ...
                         <asp:BoundField DataField="CNAME" HeaderText="客户名称" >
                          ...
                          <asp:BoundField DataField="CarType" HeaderText="车辆类型" >
                            ...
                            <asp:BoundField DataField="INSURE_COST" HeaderText="罚款金额" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                          </asp:BoundField>
...
<script type="text/javascript" language="javascript">
    function f13100302(obj,obj1,obj2,obj3,obj4,obj5) {
        var arr1 = new Array();
        arr1[0] = obj;
        arr1[1] = obj1;
        arr1[2] = obj2;
