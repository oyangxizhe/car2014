<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairTA.aspx.cs" Inherits="W0824.CostManage.RepairTA" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑维修费用信息(核)</title>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103" /> 
   ...
   <input id="Text5" type="text"  runat="server"  class="c13110901" />
     ...
     <input id="Text6" type="text"  runat="server"  onclick ="f13100202('Text6','')"   class="c13110901" />
      ...
      <div class="c13101903" id ="Div39">
          维修内容</div>
     <div class="c14011503" id ="Div40">
           <input id="Text7" type="text"  runat="server"  class="c14011801"/>
                <span style =" margin-left :5px;">
          <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="Text7" Text="必填！" runat="server" /></span> 
           </div>
