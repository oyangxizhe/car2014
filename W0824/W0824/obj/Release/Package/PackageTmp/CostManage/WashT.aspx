<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WashT.aspx.cs" Inherits="W0824.CostManage.WashT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑轮胎费用信息</title>
...
<input id="Text12" type="text"  runat="server"  onclick ="f13100202('Text12','')" class="c14011901" /> 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="Text1" Text="必填！" runat="server" /></div>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103" /> 
   ...
   <input id="Text2" type="text"  runat ="server" class ="c13110901"  onclick ="f13100202('Text2','')" readonly ="readonly"  /> 
   ...
   <input id="Text4" type="text"  runat="server" onclick ="f13100202('Text4','')"   class="c14011101" />
...
<input id="Text5" type="text"  runat="server"    class="c13110901"  />
                   <span style =" margin-left :5px;">
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="Text5" Text="必填！" runat="server" /></span>    </div>
                             <div class="c13101903" id ="Div18">
                                 单价</div>
     <div class="c13111503" id ="Div19">
     <input id="Text6" type="text"  runat="server"     class="c13110901"/>
    <span style =" margin-left :5px;">
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="Text6" Text="必填！" runat="server" /></span>
      </div>
      </div> 
           ...
           <div class ="c13101902">
                             ...
                             <div class="c13101903" id ="Div25">
                                 经手人</div>
     <div class="c13111503" id ="Div26">
     <input id="Text7" type="text"  runat="server"   onclick ="f13100202('Text7','')" class="c13110901" />
     ...
     <div class="c13122401" id ="Div109">
         ...
         <asp:TextBox ID="TextBox1" runat="server"   TextMode="MultiLine" CssClass ="c13122403"></asp:TextBox>
           ...
           <div class ="c13101902">
                                 <div class="c13102907" id ="Div23">
                                 </div>
      <div class="c13101903" id ="Div24">
          金额</div>
     <div class="c14011302" id ="Div27">
        <input id="Text9" type="text"  runat="server"    class="c13102908"/></div>
           </div>
          ...
          function f13100202(obj, obj1) {
              ...
              if (obj == "Text3") {
                  ...
                  if (dlgResult != undefined) {
                      ...
                      document.getElementById("Text4").value = dlgResult[5];
                  ...
                  dlgResult = window.showModalDialog("../BaseInfo/EMPLOYEEINFO.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0;");
                  if (dlgResult != undefined) {
                      document.getElementById("Text7").value = dlgResult[0];
