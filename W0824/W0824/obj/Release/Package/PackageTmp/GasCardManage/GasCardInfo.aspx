<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasCardInfo.aspx.cs" Inherits="W0824.GasCardManage.GasCardInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="65%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("GAID") %>','<%#Eval ("GASCARDID") %>','<%#Eval ("PLATENUM") %>');">选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="油卡号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("GASCARDID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 ...
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
                            ...
                            <asp:BoundField DataField="PLATENUM" HeaderText="车牌号码" >
                             ...
                             <asp:BoundField DataField="GECOUNT" HeaderText="开卡金额" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
