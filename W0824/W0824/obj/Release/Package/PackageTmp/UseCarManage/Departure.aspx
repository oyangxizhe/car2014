<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departure.aspx.cs" Inherits="W0824.UseCarManage.Departure" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("UCID") %>','<%#Eval ("PLATENUM") %>','<%#Eval ("DRIVERID") %>','<%#Eval ("CARTYPE") %>','<%#Eval ("DRIVER") %>');">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="用车单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("UCID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="60px" />
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                      
                             <asp:BoundField DataField="DEPARTURE_TIME" HeaderText="出车日期"  DataFormatString="{0:yyyy-MM-dd HH:mm:ss}">
                              <ItemStyle Width="120px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
                            <asp:BoundField DataField="RETURN_TIME" HeaderText="回车日期" 
                      ...
                      <asp:BoundField DataField="CNAME" HeaderText="客户名称" >
                          ...
                          <asp:BoundField DataField="UCAPPLY_STATUS" HeaderText="用车单状态" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
                             <asp:BoundField DataField="PLATENUM" HeaderText="车牌号码" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
