<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approve.aspx.cs" Inherits="W0824.UseCarManage.Approve" %>
                          ...
                          <asp:BoundField DataField="UCAPPLY_STATUS" HeaderText="用车单状态" >
                             ...
                             <asp:BoundField DataField="DRIVER" HeaderText="驾驶员" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                               ...
                               <asp:BoundField DataField="PLAN_CARTYPE" HeaderText="预约车类型" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
