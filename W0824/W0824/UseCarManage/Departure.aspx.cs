...
";
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.UseCarManage.DepartureT.strE[0] = str[0];
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../usecarmanage/departuret.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            else if (!bc.checkOriginalMakerID("UCAPPLY_MST", "UCID", id, varMakerID))
            {
                hint.Value = bc.ErrowInfo;
            }
            else
        ...
        {
            hint.Value = "";
            string var1 = bc.numYM(10, 4, "0001", "SELECT * FROM UCAPPLY_Mst", "UCID", "UC");
            DepartureT.str1[0] = var1;
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../USECARManage/DepartureT.aspx" + n2);
        }
