...
LEFT JOIN RIGHTLIST C ON A.USID=C.USID";
        ...
        protected void select()
        {
            ...
            {
                M_str_sql1 = M_str_sql + " where C.DATE BETWEEN  '" + v5 + "'AND '" + v6 + "'";
                dt = basec.getdts(M_str_sql1);
                if (dt.Rows.Count > 0)
                {
                    a(dt);
            ...
            {
                M_str_sql1 = M_str_sql + " where C.DATE BETWEEN  '" + v5 + "'AND '" + v6 + "' AND A.UNAME LIKE '%" + Text1.Value + "%'";
                dt = basec.getdts(M_str_sql1);
                if (dt.Rows.Count > 0)
                {
                    a(dt);
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            W0824.UserManage .EditRightT.strE[0] = str[0];
